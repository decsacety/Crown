...
namespace memory
{
    ...
    // If we need to align the memoty allocation we pad the header with this 
    ...
    // Given a pointer to the data, return a pointer to header before it
    ...
    // Store the size in the header and pads with HEADER_PAD_VALUE up to the 
    // data pointer.
